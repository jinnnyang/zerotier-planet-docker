...
RUN cd /app && git clone --branch ${ZT_VERSION} --progress https://ghself.markxu.online/https://github.com/zerotier/ZeroTierOne.git --depth 1\
    # && cd ./ZeroTierOne && git reset --hard ${ZT_VERSION} -- && cd .. \
